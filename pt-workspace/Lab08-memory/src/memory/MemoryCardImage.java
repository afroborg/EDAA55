...
public class MemoryCardImage {
	...
	/**
	 * Skapar en tvåsidig bild av ett memorykort. Bilden på framsidan finns i filen
	 * med namnet frontFileName och bilden på baksidan i filen med namnet
	 * backFileName.
	 */
	...
	private Image readImage(String fileName) {
		Image img = null;
		try {
			File pathToFile = new File(System.getProperty("user.dir") + "/pt-workspace/Lab08-memory/" + fileName);
